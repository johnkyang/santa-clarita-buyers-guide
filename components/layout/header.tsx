...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex h-[72px] items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex flex-col items-start leading-none mr-10">
          <span className="text-lg font-bold text-gray-900 tracking-tight">Santa Clarita</span>
          <span className="text-lg font-bold text-gray-900 tracking-tight">Buyers Guide</span>
        </Link>
